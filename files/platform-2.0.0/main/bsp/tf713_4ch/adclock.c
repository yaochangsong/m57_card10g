...
void lmx2582_1228MHz_init(volatile char * Spi_synth,uint8_t cs)
{
    ...
    spi_24bit_wrapper(Spi_synth,0x24,0x0C11,cs);
    spi_24bit_wrapper(Spi_synth,0x23,0x021f,cs);
...
void lmx2582_2456MHz_init(volatile char * Spi_synth,uint8_t cs)
{
	spi_24bit_wrapper(Spi_synth,0x00,0x0002,cs);//reset
    usleep(100);
    spi_24bit_wrapper(Spi_synth,0x40,0x0077,cs);
    ...
    spi_24bit_wrapper(Spi_synth,0x2F,0x00CF,cs);
    spi_24bit_wrapper(Spi_synth,0x2E,0x3FA3,cs);
    spi_24bit_wrapper(Spi_synth,0x2D,0x00BE,cs);
    spi_24bit_wrapper(Spi_synth,0x2C,0x0000,cs);
    spi_24bit_wrapper(Spi_synth,0x2B,0x0000,cs);
    spi_24bit_wrapper(Spi_synth,0x2A,0x0000,cs);
    spi_24bit_wrapper(Spi_synth,0x29,0x00FA,cs);
    spi_24bit_wrapper(Spi_synth,0x28,0x0000,cs);
    spi_24bit_wrapper(Spi_synth,0x27,0x8204,cs);
    spi_24bit_wrapper(Spi_synth,0x26,0x01EA,cs);
    spi_24bit_wrapper(Spi_synth,0x25,0x4000,cs);
    spi_24bit_wrapper(Spi_synth,0x24,0x0C11,cs);
    spi_24bit_wrapper(Spi_synth,0x23,0x021B,cs);
    spi_24bit_wrapper(Spi_synth,0x22,0xC3EA,cs);
    spi_24bit_wrapper(Spi_synth,0x21,0x2A0A,cs);
//----ddc0 mode
    spi_24bit_wrapper(Spi_synth,0x20,0x210A,cs);
...
void ad_9680_ddc_e6g_int(volatile char *Spi_synth,uint8_t cs)
{
    ...
    spi_wrapper(Spi_synth, 0x10b,0x01,cs);//clk div
    spi_wrapper(Spi_synth, 0x571,0x15,cs);
    spi_wrapper(Spi_synth, 0x200,0x02,cs);//ddc0 & ddc1
    spi_wrapper(Spi_synth, 0x201,0x03,cs);//dec 2
    spi_wrapper(Spi_synth, 0x10c,0x01,cs);//div
//----ddc0 mode
    spi_wrapper(Spi_synth, 0x310,0x41,cs);//test mode and dec 2 == 0x33
    spi_wrapper(Spi_synth, 0x311,0x00,cs);//ddc0 a
    spi_wrapper(Spi_synth, 0x314,0x26,cs);//nco0 f/fs*4096
...
//----ddc1 mode
    spi_wrapper(Spi_synth, 0x330,0x41,cs);
    spi_wrapper(Spi_synth, 0x331,0x05,cs);//ddc1 b
    spi_wrapper(Spi_synth, 0x334,0xa5,cs);//nco1 f/fs*4096
    spi_wrapper(Spi_synth, 0x335,0x03,cs);//nco1 f/fs*4096
...
void ad_9680_ddc_d6g_int(volatile char * Spi_synth,uint8_t cs)
{
    spi_wrapper(Spi_synth, 0x000,0x81,cs);
    usleep(10000);
    spi_wrapper(Spi_synth, 0x000,0x00,cs);
    ...
    spi_wrapper(Spi_synth, 0x03f,0x80,cs);
    spi_wrapper(Spi_synth, 0x040,0xbf,cs);
    spi_wrapper(Spi_synth, 0x10b,0x00,cs);//clk div
    spi_wrapper(Spi_synth, 0x571,0x15,cs);
    spi_wrapper(Spi_synth, 0x200,0x02,cs);//ddc0 & ddc1
    spi_wrapper(Spi_synth, 0x201,0x03,cs);//dec 2
    spi_wrapper(Spi_synth, 0x10c,0x01,cs);//div
//----ddc0 mode
    spi_wrapper(Spi_synth, 0x310,0x41,cs);//test mode and dec 2 == 0x33
    spi_wrapper(Spi_synth, 0x311,0x00,cs);//ddc0 a
    spi_wrapper(Spi_synth, 0x314,0x24,cs);//nco0 f/fs*4096
    spi_wrapper(Spi_synth, 0x315,0x05,cs);//nco0 f/fs*4096
    spi_wrapper(Spi_synth, 0x320,0x00,cs);//nco0 phase
    spi_wrapper(Spi_synth, 0x321,0x00,cs);
//----ddc1 mode
    spi_wrapper(Spi_synth, 0x330,0x41,cs);
    spi_wrapper(Spi_synth, 0x331,0x05,cs);//ddc1 b
    spi_wrapper(Spi_synth, 0x334,0xa4,cs);//nco1 f/fs*4096
    spi_wrapper(Spi_synth, 0x335,0x06,cs);//nco1 f/fs*4096
    spi_wrapper(Spi_synth, 0x340,0x00,cs);//nco1 phase
    spi_wrapper(Spi_synth, 0x341,0x00,cs);
...
static int clock_adc_fpga_init(void)
{
    ...
    usleep(10000);
    lmx2582_2456MHz_init(ca_ctx.vir_addr,0);
    usleep(10000);
    ...
    usleep(10000);
	ad_9680_ddc_e6g_int(ca_ctx.vir_addr,ADC0_CS);
    ad_9680_ddc_d6g_int(ca_ctx.vir_addr,ADC1_CS);
    usleep(10000);
