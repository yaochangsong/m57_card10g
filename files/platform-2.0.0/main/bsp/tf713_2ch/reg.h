...
/* BIQ */
#define SET_BIQ_SIGNAL_CARRIER(reg,v, ch) 		(reg->broad_band[2]->signal_carrier=v)
#define SET_BIQ_BAND(reg,v, ch) 				(reg->broad_band[2]->band=v)
#define SET_BIQ_ENABLE(reg,v, ch) 				(reg->broad_band[2]->enable=v)
