...
extern int cmd_file_auto_store(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_store(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_pause_store(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_pause_backtrace(struct uh_client *cl, void **arg, void **content);
...
extern int cmd_file_batch_delete(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_backtrace(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_backtrace_offset(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_list(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_dir(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_size(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_find(struct uh_client *cl, void **arg, void **content);
extern int cmd_file_find_rec(struct uh_client *cl, void **arg, void **content);
...
extern int cmd_file_download_cb(struct uh_client *cl, void **arg, void **content);
extern int cmd_folder_delete(struct uh_client *cl, void **arg, void **content);
extern int cmd_folder_create(struct uh_client *cl, void **arg, void **content);
extern int cmd_set_devicecode(struct uh_client *cl, void **arg, void **content);
#endif
