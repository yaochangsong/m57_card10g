...
#define FOR_EACH_HASHMAP_TYPE(i, num, offset) for(i = 0; i < num; i += offset)
#define FOR_EACH_HASHMAP_SLOT_TYPE(i) FOR_EACH_HASHMAP_TYPE(i, GET_HASHMAP_SLOT_NUM, GET_HASHMAP_SLOT_ADD_OFFSET)
#define FOR_EACH_HASHMAP_CHIP_TYPE(i) FOR_EACH_HASHMAP_TYPE(i, GET_HASHMAP_CHIP_NUM, GET_HASHMAP_CHIP_ADD_OFFSET)
#define FOR_EACH_HASHMAP_FUNC_TYPE(i) FOR_EACH_HASHMAP_TYPE(i, GET_HASHMAP_FUNC_NUM, GET_HASHMAP_FUNC_ADD_OFFSET)
#define FOR_EACH_HASHMAP_PRIO_TYPE(i) FOR_EACH_HASHMAP_TYPE(i, GET_HASHMAP_PRIO_NUM, GET_HASHMAP_PROI_ADD_OFFSET)
#define FOR_EACH_HASHMAP_PORT_TYPE(i) FOR_EACH_HASHMAP_TYPE(i, GET_HASHMAP_PORT_NUM, GET_HASHMAP_PORT_ADD_OFFSET)
