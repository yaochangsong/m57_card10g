...
extern int udp_client_delete(struct sockaddr_in *udp_addr, int type);
extern struct net_udp_server *udp_get_srv_by_addr(struct sockaddr_in *addr, int type);
