...
static struct _spm_stream spm_stream[] = {
    ...
    {2, DMA_ADC_TX0_DEV,   DMA_WRITE,NULL, DMA_BUFFER_64M_SIZE, "ADC Tx0 Stream", 0, STREAM_ADC_WRITE},
    {3, DMA_ADC_RX0_DEV,   DMA_READ, NULL, DMA_BUFFER_64M_SIZE, "ADC Rx0 Stream", 0, STREAM_ADC_READ},
};
